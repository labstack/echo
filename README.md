...
#### Soon master branch, website/docs and godoc will pointing to v2 branch, if you want to continue using v1, use a package manager to get a stable v1 release or latest commit, you can use https://github.com/Masterminds/glide, it's nice. You can also use `http://labix.org/gopkg.in` like `go get gopkg.in/labstack/echo.v1`. It is advisable to migrate to v2.
